...
@Parcelize
class ChefProfile(val chef_id: Int, val chef_name: String, val chef_flat_number: String,val about_chef: String, val chef_gender: String,val chef_specialty: String,val chef_review: Int,val chef_rating: Int,val chef_follower: Int,val testimoniallist: List<Testimonial>, var signaturedishlist: List<SignatureDish1>) : Parcelable
